...
- [x] 2.1 In `sidebar_view.rs`, add `use gpui_component::scroll::ScrollableElement;` to the imports
- [x] 2.2 In `render_sidebar`, change `.overflow_y_hidden()` on the scrollable body div to `.overflow_y_scrollbar()`
