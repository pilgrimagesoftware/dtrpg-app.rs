...
- [x] 2.1 Publishers section body shows a compact loading indicator while publishers are
      not yet known
- [x] 2.2 Collections section body shows a compact loading indicator while collections
      have not yet loaded
