# status-bar-language-selector Specification

## Purpose
A status bar control that displays and switches the app's active locale at runtime, with the selection persisted across restarts.
