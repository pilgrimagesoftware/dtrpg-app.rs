//! Activity panel overlay: lists in-progress and recently-completed background
//! operations.
...
pub fn render_activity_panel(snap: &ActivitySnapshot, entity: Entity<ActivityController>,
                             colors: &ColorTokens)
                             -> AnyElement {
...
fn render_item_row(item_id: u64, label: &str, status: &ActivityStatus, selected_id: Option<u64>,
                   activity_entity: Entity<ActivityController>, started_at: Instant,
                   elapsed_secs: Option<u64>, progress: Option<f32>, has_cancel: bool,
                   text_color: gpui::Hsla, text_tertiary: gpui::Hsla, accent: gpui::Hsla,
                   border: gpui::Hsla)
    ...
    div().id(format!("activity-row-{item_id}"))
         .flex()
         .flex_col()
         .px(px(14.0))
         .py(px(6.0))
